...
public class ProductSalesView extends javax.swing.JFrame {
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                                        ...
                                                                        .addComponent(txtProductCode, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                                                        .addComponent(txtSalesQty, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                                                        .addComponent(txtUnitePrice, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addComponent(lblAvailableQty, javax.swing.GroupLayout.DEFAULT_SIZE, 21, Short.MAX_VALUE))
                                                .addGap(21, 21, 21)
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnSalesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalesActionPerformed
        ...
        ProductSales sales = new ProductSales(txtProductName.getText().trim(), txtProductCode.getText().trim(),
                Integer.parseInt(txtSalesQty.getText().trim()), Double.parseDouble(txtUnitePrice.getText().trim()),
                Double.parseDouble(txtTotalPrice.getText().trim()), sqlDate, product);
        salesDao.save(sales);
        ...
        if (summary.getProductCode() != null) {
            ...
            int soldQty = summary.getSoldQty() + Integer.parseInt(txtSalesQty.getText().trim());
            int availableqty = summary.getAvailableQty() - Integer.parseInt(txtSalesQty.getText().trim());
    ...
    private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
        ...
        lblAvailableQty.setText(model.getValueAt(i, 5).toString());
