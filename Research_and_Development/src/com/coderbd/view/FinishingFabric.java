 ...
 * @author User
 */
public class FinishingFabric extends javax.swing.JFrame {

    /**
     * Creates new form FinishingFabric
     */
    public FinishingFabric() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Research & Development");

        jLabel2.setText("Finishing Fabric");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fabric Name", "Height", "Width", "Quantity", "Color Name", "Delivery Date"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinishingFabric.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinishingFabric().setVisible(true);
            }
        });
    }
