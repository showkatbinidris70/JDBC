 ...
 */
public class Washing_Salary_Management extends javax.swing.JFrame {

    /**
     * Creates new form Salary
     */
    public Washing_Salary_Management() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Washing Section Salary Management");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Net_salary_washing nsw = new Net_salary_washing();
        nsw.setVisible(true);
        nsw.setBounds(100, 20, 1100, 700);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Salary_washing sw = new Salary_washing();
        sw.setVisible(true);
        sw.setBounds(300, 50, 500, 500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Washing_Salary_Management.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Washing_Salary_Management().setVisible(true);
            }
        });
    }
