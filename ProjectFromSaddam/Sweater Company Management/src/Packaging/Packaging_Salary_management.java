 ...
 */
public class Packaging_Salary_management extends javax.swing.JFrame {

    /**
     * Creates new form Salary
     */
    public Packaging_Salary_management() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Packaging Section Salary");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Net_Salary_Packing nsp = new Net_Salary_Packing();
        nsp.setVisible(true);
        nsp.setBounds(100, 20, 1100, 700);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Salary_Packaging sp = new Salary_Packaging();
        sp.setVisible(true);
        sp.setBounds(300, 50, 500, 500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Packaging_Salary_management.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Packaging_Salary_management().setVisible(true);
            }
        });
    }
