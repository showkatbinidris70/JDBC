 ...
 */
public class Finishing_Salary_mamagement extends javax.swing.JFrame {

    /**
     * Creates new form Salary
     */
    public Finishing_Salary_mamagement() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Finishing Section Salary Management");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Net_salary_finishing ns = new Net_salary_finishing();
        ns.setVisible(true);
        ns.setBounds(100, 20, 1100, 700);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Salary_Finishing sf = new Salary_Finishing();
        sf.setVisible(true);
        sf.setBounds(300, 50, 500, 500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finishing_Salary_mamagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finishing_Salary_mamagement().setVisible(true);
            }
        });
    }
