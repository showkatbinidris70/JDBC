...
public class LinkingSalary extends javax.swing.JFrame {

    public LinkingSalary() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Linking Section Salary Management");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Salary_Linking sl = new Salary_Linking();
        sl.setVisible(true);
        sl.setBounds(300, 50, 500, 500);
    }//GEN-LAST:event_jLabel1MouseClicked

    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Net_Salary_linking ns = new Net_Salary_linking();
        ns.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LinkingSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LinkingSalary().setVisible(true);
            }
        });
    }
