...
public class Salary_Management extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Knitting Section Salary Management");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        NetSalary_knitting ns = new NetSalary_knitting();
        ns.setVisible(true);
        ns.setBounds(100, 20, 1100, 700);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Salary_Knitting sk = new Salary_Knitting();
        sk.setVisible(true);
        sk.setBounds(300, 50, 500, 500);
