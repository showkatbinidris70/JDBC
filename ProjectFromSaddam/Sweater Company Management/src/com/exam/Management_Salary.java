...
public class Management_Salary extends javax.swing.JFrame {

    public Management_Salary() {
        initComponents();
    }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        Management_Salary kd = new Management_Salary();
        kd.setVisible(true);
        kd.setBounds(200, 20, 900, 700);
    }//GEN-LAST:event_jLabel1MouseClicked

    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        LinkingSalary ld = new LinkingSalary();
        ld.setVisible(true);
        ld.setBounds(200, 20, 900, 700);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        Washing_Salary_Management w = new Washing_Salary_Management();
        w.setVisible(true);
        w.setBounds(200, 20, 900, 700);
    }//GEN-LAST:event_jLabel3MouseClicked

    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        Finishing_Salary_mamagement f = new Finishing_Salary_mamagement();
        f.setVisible(true);
        f.setBounds(200, 20, 900, 700);
    }//GEN-LAST:event_jLabel4MouseClicked

    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        Packaging_Salary_management p = new Packaging_Salary_management();
        p.setVisible(true);
        p.setBounds(200, 20, 900, 700);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Management_Salary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Management_Salary().setVisible(true);
            }
        });
    }
