...
public class ProductDaoImpl implements ProductDao {
    ...
    public void createTable() {
        String sql = "create table if not exists Products(id int(11) auto_increment primary key, product_name varchar(50),product_code varchar(50),quantity int(50), unit_price double, total_price double)";
        try {
    ...
    public void save(Product p) {
        String sql = "insert into Products(product_name,product_code,quantity,unit_price,total_price) values (?,?,?,?,?)";
        try {
            PreparedStatement pstm = conn.prepareStatement(sql);
