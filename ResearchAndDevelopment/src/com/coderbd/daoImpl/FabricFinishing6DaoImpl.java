...
public class FabricFinishing6DaoImpl implements FabricFinishing6Dao {
    ...
    public void save(FabricFinishing6 ff) {
        ...
        try {
            ...
            pstm.setString(7, ff.getDeliveryDate());
            pstm.executeUpdate();
    ...
    public FabricFinishing6 getFabricFinishingByFinishingName(String name) {
        ...
        try {
            ...
            while (rs.next()) {
                FabricFinishing6 fabricFinishing = new FabricFinishing6(rs.getString(1), rs.getString(2), rs.getInt(3), rs.getDouble(4), rs.getDouble(5), rs.getString(6), rs.getString(7));
            }
        } catch (SQLException ex) {
            Logger.getLogger(BuyingThread2DaoImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public List<FabricFinishing6> getList() {
        ...
        try {
            ...
            ResultSet rs = pstm.executeQuery();
            while (rs.next()) {
                FabricFinishing6 fabricFinishing6 = new FabricFinishing6(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getDouble(5), rs.getDouble(6), rs.getString(7), rs.getString(8));
